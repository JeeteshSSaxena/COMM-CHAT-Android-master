...
public class MainChatActivity extends AppCompatActivity {
    ...
    // TODO: Retrieve the display name from the Shared Preferences
            private  void setupDisplayName(){
                ...
                mDisplayName=sp.getString(RegisterActivity.DISPLAY_NAME_KEY,null);
                if(mDisplayName==null)mDisplayName="Unknown";
            }

    private void sendMessage() {

        Log.d("lets","message sent");
        // TODO: Grab the text the user typed in and push the message to Firebase
        String input=mInputText.getText().toString();
        if(!input.equals("")){
            Messenger chat=new Messenger(input,mDisplayName);
            mdbr.child("messages").push().setValue(chat);
            mInputText.setText("");
        }
    }
    ...
    // TODO: Override the onStart() lifecycle method. Setup the adapter here.
        ...
        public void onStart(){
                super.onStart();
                Log.d("lets","onstart");
                mAdapter=new ChatAdapter(this,mdbr,mDisplayName);
